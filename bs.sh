...
#Now Its time for other stuffs like cloning, exporting, etc
 ...
 clone() {
	...
	then
		...
		git clone --depth=1 https://gitlab.com/mcdofrenchfreis/android-clang-14.0.7 clang
	...
	git clone --depth 1 https://github.com/REDGROUL/AnyKernel3.git -b xiaomi AnyKernel3
